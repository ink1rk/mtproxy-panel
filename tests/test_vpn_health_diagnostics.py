"""Проверяем человекочитаемые вердикты diagnose_client (без реального хоста)."""
...
class DiagnoseClientTests(unittest.TestCase):
    def test_never_connected(self) -> None:
        d = vh.diagnose_client(name="iphone", handshake_epoch=0, rx_bytes=0, tx_bytes=0)
